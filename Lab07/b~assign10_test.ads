...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_assign10_test" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7da175c7#;
   pragma Export (C, u00001, "assign10_testB");
   ...
   u00127 : constant Version_32 := 16#95c03aaa#;
   pragma Export (C, u00127, "system__direct_ioB");
   u00128 : constant Version_32 := 16#e2a2a0d7#;
   pragma Export (C, u00128, "system__direct_ioS");
   u00129 : constant Version_32 := 16#1eab0e09#;
   pragma Export (C, u00129, "system__img_enum_newB");
   u00130 : constant Version_32 := 16#eaa85b34#;
   pragma Export (C, u00130, "system__img_enum_newS");
   u00131 : constant Version_32 := 16#96c125d4#;
   pragma Export (C, u00131, "system__val_enumB");
   u00132 : constant Version_32 := 16#d6b5d251#;
   pragma Export (C, u00132, "system__val_enumS");
