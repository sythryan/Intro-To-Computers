pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~assign7.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~assign7.adb");
with Ada.Exceptions;
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_assign7");
